<template>
  <header class="top-header">
    ...
    <div class="header-right">
      ...
      <div v-if="userStore.user" class="user-panel">
        <div class="user-meta">
...
const roleLabel = computed(() => {
  ...
  if (userStore.user.role === 'safety_officer') return 'Safety'
  if (userStore.user.role === 'team_leader') return 'Leader'
  return 'Worker'
})
...
async function handleLogout() {
  try {
    ...
    // Best-effort logout. Local auth state should still be cleared.
  }
  userStore.clearUser()
  router.push('/login')
}
