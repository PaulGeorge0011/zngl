...
SMS_API_URL = os.getenv(
    'SMS_API_URL',
    'https://yxcf-yzyy.ynzy-tobacco.com/647442ae02137c524c8565f9/api/open/647442ae02137c524c8565f9/common/message',
)
SMS_SYSTEM_NAME = os.getenv('SMS_SYSTEM_NAME', '数智生产')
SMS_TIMEOUT = int(os.getenv('SMS_TIMEOUT', '8'))
