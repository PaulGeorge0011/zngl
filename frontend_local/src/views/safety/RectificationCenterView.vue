  ...
  <div class="page-container">
    <div class="page-header">
      ...
      <div class="header-right">
        ...
        <el-button
          v-if="isOfficer" plain type="primary" size="small"
          @click="assignerDialogVisible = true"
        >
          分派人管理
        </el-button>
      </div>
    ...
    <AssignerManagementDialog v-model:visible="assignerDialogVisible" />
...
import AssignerManagementDialog from '@/components/safety/AssignerManagementDialog.vue'
...
const assignerDialogVisible = ref(false)
